...
%apply std::string & OUTPUT { std::string & arg1, std::string & arg2, std::string & arg3 };
%apply std::string & INPUT  { std::string & arg1, std::string & arg2, std::string & arg3 };
...
%include "UniFile.i"
%include "UniDictionary.i"
%include "UniSession.i"
...
VALUE open(char *server,char *userid, char *password, char *account) {
  UniSession *pSession = new UniSession(server,userid,password,account);
  return pSession->open();
}
